...
func TestGetRepertoireHandler_SetsETag(t *testing.T) {
	...
	mockRepo := &mocks.MockRepertoireRepo{
		...
		GetByIDFunc:       func(id string) (*models.Repertoire, error) { return repWithNodeAtVersion(id, 5), nil },
	}
...
func TestMutation_NoIfMatch_Succeeds(t *testing.T) {
	...
	mockRepo := &mocks.MockRepertoireRepo{
		BelongsToUserFunc: func(id, userID string) (bool, error) { return true, nil },
		GetByIDFunc:       func(id string) (*models.Repertoire, error) { return repWithNodeAtVersion(id, 2), nil },
...
func TestMutation_StaleIfMatch_Returns409(t *testing.T) {
	...
	mockRepo := &mocks.MockRepertoireRepo{
		BelongsToUserFunc: func(id, userID string) (bool, error) { return true, nil },
		GetByIDFunc:       func(id string) (*models.Repertoire, error) { return repWithNodeAtVersion(id, 4), nil },
		SaveFunc: func(id string, userID string, treeData models.RepertoireNode, metadata models.Metadata, expectedVersion int) (*models.Repertoire, error) {
			saveCalled = true
			return nil, nil
		},
...
func TestMutation_MalformedIfMatch_Returns400(t *testing.T) {
	...
	mockRepo := &mocks.MockRepertoireRepo{
		BelongsToUserFunc: func(id, userID string) (bool, error) { return true, nil },
		GetByIDFunc:       func(id string) (*models.Repertoire, error) { return repWithNodeAtVersion(id, 1), nil },
	}
	svc := services.NewRepertoireService(mockRepo)
	require.NoError(t, UpdateNodeCommentHandler(svc)(c))
