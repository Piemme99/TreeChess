...
const button = cva(
  'inline-flex items-center justify-center gap-2 font-medium border-none rounded-md cursor-pointer transition-all duration-150 ease-in-out disabled:opacity-50 disabled:cursor-not-allowed focus-visible:outline-2 focus-visible:outline-primary focus-visible:outline-offset-2',
  {
    variants: {
      variant: {
        primary: 'bg-primary text-white hover:not-disabled:bg-primary-hover',
        secondary: 'bg-bg text-text border border-border hover:not-disabled:bg-border',
