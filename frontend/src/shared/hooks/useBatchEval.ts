...
import { STOCKFISH_WORKER_PATH, getOptimalThreadCount } from '../../services/stockfishConfig';
...
export interface MoveEvalDelta {
  ...
  /** Win%-based move classification. null for opponent moves or if not yet computed. */
  classification: MoveClassification | null;
}

/**
 * Spawns a dedicated Stockfish worker that evaluates all positions in a game
 * at low depth. Returns per-move eval deltas progressively with Win%-based
 * move classification.
 *
