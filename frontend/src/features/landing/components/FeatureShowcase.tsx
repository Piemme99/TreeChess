...
const TABS = [
  ...
  },
  {
    ...
    label: 'Auto-Sync',
    icon: RefreshCw,
    description: 'Connect Lichess or Chess.com and let Kumquat auto-import your games. Never miss a deviation again.',
    screen: SyncScreen,
  },
  {
    id: 'studies',
      ...
      <div className="max-w-6xl mx-auto">
        <motion.div variants={fadeUp} initial="hidden" animate={inView ? 'visible' : 'hidden'} className="text-center mb-14">
          ...
          <p className="text-text-muted max-w-xl mx-auto leading-relaxed">
            From importing your games to building complete repertoires, Kumquat
